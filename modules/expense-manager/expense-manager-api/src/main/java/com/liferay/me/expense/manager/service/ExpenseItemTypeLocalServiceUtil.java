...
/**
 * Provides the local service utility for ExpenseItemType. This utility wraps
 * <code>com.liferay.me.expense.manager.service.impl.ExpenseItemTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ExpenseItemTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.me.expense.manager.service.impl.ExpenseItemTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ExpenseItemType addExpenseItemType(
		ExpenseItemType expenseItemType) {

		return getService().addExpenseItemType(expenseItemType);
	}
	 ...
	 */
	public static ExpenseItemType createExpenseItemType(
		long expenseItemTypeId) {

		return getService().createExpenseItemType(expenseItemTypeId);
	}
	 ...
	 */
	public static ExpenseItemType deleteExpenseItemType(
		ExpenseItemType expenseItemType) {

		return getService().deleteExpenseItemType(expenseItemType);
	}
	 ...
	 */
	public static ExpenseItemType deleteExpenseItemType(long expenseItemTypeId)
		throws PortalException {

		return getService().deleteExpenseItemType(expenseItemTypeId);
	}
	...
	public static ExpenseItemType fetchExpenseItemType(long expenseItemTypeId) {
		return getService().fetchExpenseItemType(expenseItemTypeId);
	}
	 ...
	 * @throws PortalException if a expense item type with the primary key could not be found
	 */
	public static ExpenseItemType getExpenseItemType(long expenseItemTypeId)
		throws PortalException {

		return getService().getExpenseItemType(expenseItemTypeId);
	}
	...
	public static List<ExpenseItemType> getExpenseItemTypes(
		...
		return getService().getExpenseItemTypes(start, end);
	}
	...
	public static int getExpenseItemTypesCount() {
		return getService().getExpenseItemTypesCount();
	}
	 ...
	 */
	public static ExpenseItemType updateExpenseItemType(
		ExpenseItemType expenseItemType) {

		return getService().updateExpenseItemType(expenseItemType);
	}
	...
	public static ExpenseItemTypeLocalService getService() {
		return _service;
	}

	private static volatile ExpenseItemTypeLocalService _service;
